    ...
    ***************************************************************************** */
            ...
            if (filter.contextType) {
                filteredHandlers = handlers.filter((handler) => {
                    ...
                    if (handler.instanceId) {
                        const appExists = window.glue42gd && handler.applicationName === Glue42EnterpriseNoAppWindow
                            ? false
    ...
    class ApplicationsController {
        ...
        getBaseGlueAppToAppMetadata(app) {
            return __awaiter(this, void 0, void 0, function* () {
                const appConfiguration = window.glue42gd
                    ? yield app.getConfiguration()
                    : app.userProperties;
                const icon = window.glue42gd
